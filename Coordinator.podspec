...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Duc Pham Dinh/Coordinator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Duc Pham Dinh' => 'ducpd@tech.est-rouge.com' }
  s.source           = { :git => 'https://github.com/Duc Pham Dinh/Coordinator.git', :tag => s.version.to_s }
